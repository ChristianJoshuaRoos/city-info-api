...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
        ...
        public PointsOfInterestController(ILogger<PointsOfInterestController> logger,
            IMailService mailService, ICityInfoRepository cityInfoRepo, IMapper mapper)
        {
            _logger = logger ?? throw new ArgumentNullException(nameof(logger));
            _mailService = mailService ?? throw new ArgumentNullException(nameof(mailService));
            _cityInfoRepository = cityInfoRepo ?? throw new ArgumentNullException(nameof(cityInfoRepo));
        ...
        public IActionResult GetPointsOfInterest(int cityId)
        {
            try
            {
                ...
                {
                    _logger.LogInformation($"City with id {cityId} was not found when accessing" +
                        "points of interest.");
                    return NotFound();
                }
            ...
            {
                _logger.LogCritical($"Exception thrown while getting points of interest for city with id {cityId}.", e);
